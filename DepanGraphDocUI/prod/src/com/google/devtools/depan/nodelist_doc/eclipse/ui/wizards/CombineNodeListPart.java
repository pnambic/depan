 ...
 */
public class CombineNodeListPart implements NewWizardOptionPart {
  ...
  public CombineNodeListPart(CompositeWizardPage containingPage) {
  ...
  /**
   * Provide the terms  for the operation.
   */
